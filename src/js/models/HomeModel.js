            ...
            for (const col of data) {
                    ...
                    for (const tk of col.data.tasks) {
                        taskColumns += `
                            <div class="flex flex-col">
                                <div id="task-${tk.id}" tabindex="0" data-board="${id}" data-column="${col.id}" data-task="${tk.id}" class="w-full bg-white rounded-xl p-3 mt-2 drop-shadow-md">
                                ...
                                <div id="task-form-${tk.id}" class="hidden w-full bg-white mt-4 rounded-xl p-3 mt-2 drop-shadow-md">
                                    <form class="flex flex-col">
                                        <input id="title-form-task-${tk.id}" name="title" type="text" class="text-base font-bold p-1 bg-white" placeholder="Título..." value="${tk.title}">
                                        <textarea id="desc-form-task-${tk.id}" name="description" class="text-sm leading-none p-1" placeholder="Descripción..." rows="3">${tk.description}</textarea>
                                        <div class="flex mt-2">
                ...
                this.colsKanban.insertAdjacentHTML('beforeend', `
                    <div class="bg-slate-100 mt-8 p-4 rounded-3xl mr-4 max-h-full">
                        ...
                        <div class="flex flex-col mt-4 max-h-96 overflow-auto">
                            ${taskColumns}
